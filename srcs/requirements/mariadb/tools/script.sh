...
service mariadb start
	...
	mariadb -uroot -e "CREATE USER IF NOT EXISTS '$MARIADB_USER'@'localhost' IDENTIFIED BY '$ADMIN_PASSWORD';"
	mariadb -uroot -e "GRANT ALL PRIVILEGES ON $MARIADB_DATABASE.* TO '$ADMIN_USER'@'%' IDENTIFIED BY '$ADMIN_PASSWORD';"
